            ...
            <div
              className={[
                ...
                visiblePanes.has("diff")
                  ? `md:flex${desktopIsSolo || firstVisiblePane === "diff" ? " md:flex-1" : " md:[width:var(--pane-w)] md:[flex-shrink:0]"}`
                  : "md:hidden",
              ].join(" ")}
            ...
            <div
              className={[
                ...
                visiblePanes.has("terminal")
                  ? `md:flex${desktopIsSolo || firstVisiblePane === "terminal" ? " md:flex-1" : " md:[width:var(--pane-w)] md:[flex-shrink:0]"}`
                  : "md:hidden",
              ].join(" ")}
            ...
            <div
              className={[
                ...
                visiblePanes.has("activity")
                  ? `md:flex${desktopIsSolo || firstVisiblePane === "activity" ? " md:flex-1" : " md:[width:var(--pane-w)] md:[flex-shrink:0]"}`
                  : "md:hidden",
              ].join(" ")}
