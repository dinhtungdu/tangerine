...
function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex h-8 items-center gap-1.5 rounded-md px-2 text-muted-foreground outline-none transition hover:text-foreground focus-visible:ring-1 focus-visible:ring-ring/50"
      title={`Theme: ${label}`}
    >
      {theme === "dark" && (
      ...
      <div className="flex items-center gap-4">
        {onToggleSidebar !== undefined && (
          <button
            ...
            className="hidden h-8 w-8 items-center justify-center rounded-md text-muted-foreground outline-none transition hover:text-foreground focus-visible:ring-1 focus-visible:ring-ring/50 md:flex"
        ...
        <Link to={`/${qs}`} className="flex items-center gap-2 rounded-md outline-none focus-visible:ring-1 focus-visible:ring-ring/50">
