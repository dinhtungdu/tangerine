...
const mockTasks = [
  {
    ...
    provider: "opencode" as const, vmId: null, branch: "main", worktreePath: null, prUrl: null, userId: null, agentSessionId: null,
    agentPort: null, previewPort: null, error: null,
