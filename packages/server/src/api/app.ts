...
export interface AppDeps {
  db: Database
  taskManager: {
    createTask(params: { source: TaskSource; projectId: string; title: string; description?: string; sourceId?: string; sourceUrl?: string; provider?: string; model?: string; reasoningEffort?: string; branch?: string; images?: import("../agent/provider").PromptImage[]; type?: "code" | "review"; reviewPrNumber?: number; reviewTaskId?: string }): Effect.Effect<TaskRow, TaggedError>
