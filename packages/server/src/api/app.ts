...
export interface AppDeps {
  db: Database
  taskManager: {
    createTask(params: { source: TaskSource; projectId: string; title: string; type?: import("@tangerine/shared").TaskType; description?: string; sourceId?: string; sourceUrl?: string; provider?: string; model?: string; reasoningEffort?: string; branch?: string; prUrl?: string; parentTaskId?: string; images?: import("../agent/provider").PromptImage[] }): Effect.Effect<TaskRow, TaggedError>
