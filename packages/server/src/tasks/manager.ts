...
export interface TaskManagerDeps {
  insertTask(task: Pick<TaskRow, "id" | "project_id" | "source" | "repo_url" | "title"> & Partial<Pick<TaskRow, "source_id" | "source_url" | "description" | "user_id" | "branch" | "provider" | "model" | "reasoning_effort" | "type" | "review_pr_number" | "review_task_id">>): Effect.Effect<TaskRow, Error>
...
export function createTask(
  ...
  return Effect.gen(function* () {
    ...
    const task = yield* deps.insertTask({
      ...
      review_pr_number: params.reviewPrNumber ?? null,
